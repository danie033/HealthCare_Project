"""
Simple Google Drive dataset downloader copied from Lab 2. to load data in spark
...
FILE_ID = "1Nji6-QTX_mioySKgwo4dfx9T6yIyqg_O"
...
def ensure_dataset(
    ...
    dataset_dirname: str = "final_data",
    file_id: str = FILE_ID,
    keep_zip: bool = False,
) -> Path:
    """
    (Re)create Project/dataSets/final_data by downloading and extracting the zip.

    Returns the dataset directory path.
    """
    # If not provided, default to Project/dataSets
    if base_dir is None:
    ...
    print(f"Extracting CSVs into {dataset_dir} ...")
